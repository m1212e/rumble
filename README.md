...
> Comes with a fully TS based client to consume any GraphQLAPI. See the client docs at the end to learn about usage with rumable and independent usage with any GraphQL API.
